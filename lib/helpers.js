...
function buildNav(user) {
  ...
  return `
    ...
    <div class="user-area">
      ...
      <a href="/my/profile" style="display:flex;align-items:center;gap:8px;text-decoration:none;color:#1e293b">
...
module.exports = { render, isLoggedIn, isAuthor, isStudyLeader, isAdmin, needsSetup, buildNav, escapeHtml, addPoints, notify, ROLE_LABELS };
