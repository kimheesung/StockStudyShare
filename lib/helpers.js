...
function buildNav(user) {
  ...
  const adminLink = user.role === 'admin'
    ? `<a href="/admin" class="nav-item">관리자</a>` : '';
  ...
  return `
    <style>
      ...
      .nav-item{padding:7px 14px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:50px;color:rgba(255,255,255,0.75);text-decoration:none;font-size:0.78rem;font-weight:600;transition:all 0.2s;white-space:nowrap}
      .nav-item:hover{transform:translateY(-1px);filter:brightness(1.3)}
    ...
    <div class="nav-links">
      <a href="/dashboard" class="nav-item" style="background:linear-gradient(135deg,rgba(79,70,229,0.12),rgba(6,182,212,0.08));border-color:rgba(79,70,229,0.25);color:#a5b4fc">🏠 대시보드</a>
      <a href="/study" class="nav-item" style="background:linear-gradient(135deg,rgba(34,197,94,0.1),rgba(6,182,212,0.08));border-color:rgba(34,197,94,0.25);color:#4ade80">📚 스터디방</a>
      <a href="/author/reports/new" class="nav-item" style="background:linear-gradient(135deg,rgba(6,182,212,0.12),rgba(79,70,229,0.08));border-color:rgba(6,182,212,0.25);color:#67e8f9">✏️ 리포트 작성</a>
      <a href="/reports" class="nav-item" style="background:linear-gradient(135deg,rgba(168,85,247,0.1),rgba(79,70,229,0.08));border-color:rgba(168,85,247,0.25);color:#c084fc">🔍 리포트 검색</a>
      <a href="/visit-notes" class="nav-item" style="background:linear-gradient(135deg,rgba(34,197,94,0.12),rgba(251,191,36,0.08));border-color:rgba(34,197,94,0.25);color:#86efac">🗒️ 탐방노트</a>
      <a href="/author/dashboard" class="nav-item" style="background:linear-gradient(135deg,rgba(59,130,246,0.1),rgba(79,70,229,0.08));border-color:rgba(59,130,246,0.25);color:#93c5fd">📊 내 리포트</a>
      <a href="/my/purchases" class="nav-item" style="background:linear-gradient(135deg,rgba(251,191,36,0.1),rgba(245,158,11,0.08));border-color:rgba(251,191,36,0.25);color:#fcd34d">📦 내 구매내역</a>
      <a href="/contest" class="nav-item" style="background:linear-gradient(135deg,rgba(239,68,68,0.12),rgba(251,191,36,0.1));border-color:rgba(239,68,68,0.25);color:#f87171">🏆 치킨배</a>
      <a href="/community" class="nav-item" style="background:linear-gradient(135deg,rgba(236,72,153,0.1),rgba(168,85,247,0.08));border-color:rgba(236,72,153,0.25);color:#f9a8d4">💬 생각나누기</a>
      <a href="/my/shop" class="nav-item" style="background:linear-gradient(135deg,rgba(245,158,11,0.15),rgba(239,68,68,0.1));border-color:rgba(245,158,11,0.3);color:#fbbf24">🛒 상점</a>
      ${adminLink}
    </div>
    <div class="user-area">
      ...
      <span style="font-size:0.68rem;padding:3px 10px;border-radius:10px;font-weight:700;${
        user.role === 'admin' ? 'background:rgba(168,85,247,0.1);color:#7c3aed' :
