...
function buildNav(user) {
  ...
  return `
    ...
    <div class="nav-links">
      ...
      <a href="/author/reports/new" class="nav-item">리포트 작성하기</a>
      <a href="/reports" class="nav-item">리포트 검색</a>
      <a href="/visit-notes" class="nav-item">탐방노트</a>
      <a href="/author/dashboard" class="nav-item">내 리포트</a>
      <a href="/my/purchases" class="nav-item">내 구매내역</a>
      <a href="/contest" class="nav-item" style="background:linear-gradient(135deg,rgba(239,68,68,0.12),rgba(251,191,36,0.1));border-color:rgba(239,68,68,0.25);color:#f87171">&#127942; 경진대회</a>
      <a href="/community" class="nav-item">생각나누기</a>
